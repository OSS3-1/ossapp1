  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="/dealerships">Jobs list</a></li>
        <li><a href="/groups">My Jobs</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
	      <li class="dropdown">
	        ...
	        <ul class="dropdown-menu" role="menu">
	          <li><?= $this->Html->link(__('<i class="fa fa-user" aria-hidden="true"></i> Ver Perfil'), ['controller' => 'Users', 'action' => 'view', $current_user['id']], ['escape' => false]) ?></li>
